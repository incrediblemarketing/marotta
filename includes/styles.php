...
function im_register_styles() {
	...
	wp_register_style( 'adobe-fonts', 'https://use.typekit.net/xdy6tqu.css', '', $theme_version, 'all' );
	wp_register_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Tangerine&display=swap', '', $theme_version, 'all' );
